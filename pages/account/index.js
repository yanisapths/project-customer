    ...
    <div>
      ...
      <main className="bg-[#7BC6B7] pb-48">
        <div className="flex pt-8 items-center justify-center">
          <div className="shadow-xl rounded-2xl max-w-screen-lg sm:px-24 px-32 pt-10 pb-20 bg-white">
                ...
                <div className="pt-6 grid grid-cols-6 gap-6">
                  <div className="col-span-3">
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="inputOutline placeholder-gray-900"
...
export async function getServerSideProps(context) {
  ...
  if (session) {
    const url = `${process.env.dev}/customer/${session.user.id}`;
    try {
