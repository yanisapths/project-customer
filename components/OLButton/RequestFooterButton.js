...
function RequestFooterButton({handleClick}) {
  return (
    ...
    transform duration-100 ease-out cursor-pointer">
          <div
            onClick={handleClick}
            className="w-full py-4 rounded-full border border-[#7BC6B7] bg-[#7BC6B7] shadow-lg text-white hover:bg-[#FDFFF5] hover:text-[#7BC6B7] focus:outline-none focus:ring active:text-[#7BC6B7]"
          >
