...
function FooterSocial() {
  return (
    ...
    <div class="max-w-screen-xl px-4 pt-30 md:pt-32 pb-12 mx-auto sm:px-6 lg:px-8">
  
      <div class="pt-12 mt-32 border-t border-black/25 sm:items-center sm:justify-between sm:flex">
